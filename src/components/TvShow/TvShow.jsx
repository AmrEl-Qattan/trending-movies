...
export default function TvShow() {
  ...
  async function getTrending(page) {
    let { data } = await axios.get(
      `https://api.themoviedb.org/3/discover/tv?api_key=24d5953b892243c9cd844457f6524ac1&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=${page}`
    );
  ...
  return (
    ...
    <HelmetProvider>
    <Helmet>
    <title>Trending Movies - TvShow</title>
   </Helmet>
   </HelmetProvider>
    ...
    {tv.length > 0 ? <>
      ...
      <nav className="py-5">
        ...
        {tv.map((item , index)=> <div key={index} className="col-md-3 col-sm-6 col-lg-2 mb-5">
          <Link
